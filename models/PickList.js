...
const pickItemSchema = new mongoose.Schema({
  ...
  sortingVersion: { type: Number, default: 0, min: 0 },
  sortingPostedAt: Date,
  sortingPostedBy: { type: mongoose.Schema.Types.ObjectId, ref: 'User' },
  sortingReason: { type: String, default: '' },
  sortingShortMovement: { type: mongoose.Schema.Types.ObjectId, ref: 'StockMovement' },
  sortingDamageMovement: { type: mongoose.Schema.Types.ObjectId, ref: 'StockMovement' },
  sortingDiscrepancyResolved: { type: Boolean, default: false },
